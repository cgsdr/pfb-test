...
class pfb_test2(gr.top_block):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + 'soapy=0,driver=remote,remote=tcp://cgsdr-R1:55132' )
        self.osmosdr_source_0.set_sample_rate(samp_rate)
        self.osmosdr_source_0.set_center_freq(470887500, 0)
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_gr_complex*1, 'localhost', 7355, 1472, True)
